          ...
          <div class="row">
            <div class="col-lg-6 col-md-12 mb-3"><!-- Columna izquierda -->
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('tipo_documento', $tipos_documentos, null, [
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('id_pais', $paises, null, [
                ...
                <div id="group-municipio" class="form-group">
                    ...
                    <select id="select-municipio" name="municipio" class="form-control {{ $errors->has('municipio') ? 'is-invalid' : '' }}">
                        @foreach ($municipios as $municipio)
                            <option value="{{ $municipio->id }}" data-departamento="{{ $municipio->id_departamento }}">{{ $municipio->nombre }}</option>
                        @endforeach
                    </select>
                    @error('municipio')
                    <div class="invalid-feedback">{{ $message }}</div>
